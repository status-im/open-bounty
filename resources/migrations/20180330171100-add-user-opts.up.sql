...
ALTER TABLE users ADD COLUMN opts JSONB;

UPDATE users
SET opts=jsonb_set('{}', '{is_hidden_in_hunters}', to_jsonb(is_hidden_in_hunters)) ;
...
ALTER TABLE users DROP COLUMN is_hidden_in_hunters;
ALTER TABLE users DROP COLUMN welcome_email_sent;
