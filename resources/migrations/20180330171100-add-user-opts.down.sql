...
ALTER TABLE users ADD COLUMN is_hidden_in_hunters BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN welcome_email_sent INTEGER;

UPDATE users
SET is_hidden_in_hunters = (opts->>'is_hidden_in_hunters')::boolean;
...
ALTER TABLE users DROP COLUMN opts;
